...
async def async_setup_entry(
    ...
    def set_menu_index():
        ...
        entities = hass.data[DOMAIN][config_entry.entry_id]["entities"]
        menu_options_entity_id = get_entity_id(
            device_info, MENU_OPTIONS, SELECT_ENTITY_ID_FORMAT
        )
        ...
        auto_keep_warm_entity_id = get_entity_id(
            device_info, AUTO_KEEP_WARM, SWITCH_ENTITY_ID_FORMAT
        )
        auto_keep_warm: bool = entities[auto_keep_warm_entity_id].is_on

        schedule_entity_id = get_entity_id(
            device_info, SCHEDULE_TIME, TIME_ENTITY_ID_FORMAT
        )
