...
SENSOR_TYPES = [
    ...
    (
        ...
        "min",
        "mdi:timelapse",
        lambda t: int(t.total_seconds() // 60),
    ),
...
async def async_setup_entry(
    ...
    for sensor_type_config in SENSOR_TYPES:
        tokit_cooker_sensor = TokitCookerSensor(
            coordinator, device_info, device_name, sensor_type_config
        )
